...
local function baseModel(sex)
    if (sex == 'mp_male') then
        ...
        Citizen.InvokeNative(0xD3A7B003ED343FD9, charPed, 612262189, true, true, true); -- eyes
        ...
        Citizen.InvokeNative(0xD3A7B003ED343FD9, charPed, 869083847, true, true, true); -- eyes
